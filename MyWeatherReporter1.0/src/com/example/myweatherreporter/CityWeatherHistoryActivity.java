...
public class CityWeatherHistoryActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//String link="<html><a href=\"http://m.openWeatherMap.org/city/1259229\">openweathermap.org</a></html>";
		//String link=StringUtils.getLinkString(1259229);
		//Log.d("Link String", link);
		//txtSourceLink.setText(Html.fromHtml(link));
